    ...
    items: [
      {
        ...
        type: 'normal',
        items: [
          { name: 'Robot', label: 'Robot', route: '/', type: 'route', Icon: BookmarkBorderIcon },
          { name: 'Robot2', label: 'Robot 2', route: '/robot2', type: 'route', Icon: BookmarkBorderIcon }
        ]
      }
    ]
  }
    ...
    <div className="row main_section">
      ...
      <div className="col-md-9 p-0">
        <Switch>
          ...
          <Route exact path="/robot2" component={Visualizer} />
